...
// Following code will get all attended events for selected month of certain user
...
$result = mysql_query("SELECT * FROM attends where user_id = '$userId' AND status <> '$status' AND private = '$privacy' AND attend_date >= '$beginDate' AND attend_date <= '$endDate'") or die(mysql_error());
